...
function CreateBalance(props) {
      ...
      const {
            value: enteredPaymentTerms,
            isValid: enteredPaymentTermsIsValid,
            hasError: enteredPaymentTermsHasError,
            valueChangeHandler: paymentTermsChangeHandler,
            inputBlurHandler: paymentTermsBlurHandler,
      } = useInput((value) => value.trim() !== '');
      const {
      ...
      if (
            enteredSchoolYearFromIsValid &&
            enteredSchoolYearToIsValid &&
            enteredPaymentTermsIsValid &&
            enteredModeOfPaymentIsValid
      ) {
            formIsValid = true;
      }
                  ...
                  const postData = async () => {
                        try {
                              const response = await axios.post(
                                    `http://localhost:4000/api/accountant/students/${props.id}/newbalance`,
                                    balanceData,
                              ...
                              >
                                    ...
                                    <div className={styles.inputContainer}>
                                          <input
                                                ...
                                                onBlur={modeOfPaymentBlurHandler}
                                          />
                                    </div>
                              </div>
                        </div>
