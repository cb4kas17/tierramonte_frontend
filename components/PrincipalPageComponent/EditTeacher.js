            ...
            const postData = async () => {
                  try {
                        const response = await axios.put(
                              `http://localhost:4000/api/principal/teachers/${props.data._id}`,
                              userData,
      ...
      const archiveUser = async () => {
            try {
                  const response = await axios.delete(
                        `http://localhost:4000/api/principal/archiveteacher/${props.data._id}`,
                        {
                              withCredentials: true,
                              credentials: 'include',
                        }
                              ...
                              <Modal className={styles.modalDesign}>
                                    <div className={styles.messageContainer}>
                                          ...
                                          <h4 className={styles.messageBody}>
                                                ...
                                                teacher to the List of Teacher
                                                Tab
                                          </h4>
