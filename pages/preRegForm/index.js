      ...
      const postData = async () => {
         try {
            ...
            if (response.data === "prereg created!") {
               router.push("/");
            } else if (response.data === "student email is in use!") {
               setErrorMes(true);
               setErrorMesParent(false);
            } else if (response.data === "parent email is in use!") {
               setErrorMes(false);
         ...
         <div className={styles.formContainer}>
            <div className={styles.yearSection}>
               <div>
                  ...
                  <input
                     ...
                     onChange={() => setOnReturningStudent(!onReturningStudent)}
                  />
               </div>
               <div>
            ...
            <div className={styles.studentSection}>
               ...
               <div>
                  ...
                  <input type="text" id="indigenous" ref={indigenousRef} />
               </div>
               <div>
            ...
            <div className={styles.checkboxContainer}>
               <label htmlFor="item1" className={styles.radioContainer}>
                  ...
                  <input
                     ...
                     id="item1"
                     checked={firstItem}
                     onChange={() => setFirstItem(!firstItem)}
                  />
               ...
               <label htmlFor="item2" className={styles.radioContainer}>
                  ...
                  <input
                     ...
                     id="item2"
                     checked={secondItem}
                     onChange={() => setSecondItem(!secondItem)}
                  />
                  <span className={styles.checkmark}></span>
               </label>
               <label htmlFor="item3" className={styles.radioContainer}>
                  ...
                  <input
                     ...
                     id="item3"
                     checked={thirdItem}
                     onChange={() => setThirdItem(!thirdItem)}
                  />
                  <span className={styles.checkmark}></span>
               </label>
               <label htmlFor="item4" className={styles.radioContainer}>
                  ...
                  <input
                     ...
                     id="item4"
                     checked={fourthItem}
                     onChange={() => setFourthItem(!fourthItem)}
                  />
                  <span className={styles.checkmark}></span>
               </label>
               <label htmlFor="item5" className={styles.radioContainer}>
                  ...
                  <input
                     ...
                     id="item5"
                     checked={fifthItem}
                     onChange={() => setFifthItem(!fifthItem)}
                  />
                  <span className={styles.checkmark}></span>
               </label>
               <label htmlFor="item6" className={styles.radioContainer}>
                  ...
                  <input
                     ...
                     id="item6"
                     checked={sixthItem}
                     onChange={() => setSixthItem(!sixthItem)}
                  />
                  <span className={styles.checkmark}></span>
               </label>
               <label htmlFor="item7" className={styles.radioContainer}>
                  ...
                  <input
                     ...
                     id="item7"
                     checked={seventhItem}
                     onChange={() => setSeventhItem(!seventhItem)}
                  />
                  <span className={styles.checkmark}></span>
               </label>
               <label htmlFor="item8" className={styles.radioContainer}>
                  ...
                  <input
                     ...
                     id="item8"
                     checked={eighthItem}
                     onChange={() => setEighthItem(!eighthItem)}
                  />
                  <span className={styles.checkmark}></span>
               </label>
            </div>
